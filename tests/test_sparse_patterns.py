# test_sparse_patterns.py -- Tests for sparse checkout pattern handling
# Copyright (C) 2023
#
# SPDX-License-Identifier: Apache-2.0 OR GPL-2.0-or-later
#
# This file is part of Dulwich, a Python implementation of Git.
# You should have received a copy of the licenses; if not, see
# <http://www.gnu.org/licenses/> and <http://www.apache.org/licenses/LICENSE-2.0>.
#
