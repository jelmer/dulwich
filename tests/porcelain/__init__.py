...
def _bugreport_section(report, name):
    """Return the body of a named section of a bugreport."""
...
class BugreportSystemInfoTests(TestCase):
    ...
    def test_reports_without_a_repository(self) -> None:
        ...
        report = porcelain.bugreport(None, env={})
        self.assertIn("[System Info]", report)
        self.assertEqual("<no repository>", _bugreport_section(report, "Enabled Hooks"))
    ...
    def test_records_the_shell_from_the_supplied_environment(self) -> None:
        ...
        """
        report = porcelain.bugreport(None, env={"SHELL": "/bin/somesh"})
        self.assertIn("/bin/somesh", report)

    def test_an_unset_shell_is_reported_as_unset(self) -> None:
        self.assertIn(
            "$SHELL (typically, interactive shell): <unset>",
            porcelain.bugreport(None, env={}),
        )

    def test_ends_with_a_newline(self) -> None:
        self.assertTrue(porcelain.bugreport(None, env={}).endswith("\n"))
...
class BugreportHookTests(TestCase):
    ...
    def test_a_repository_with_no_hooks(self) -> None:
        self.assertEqual(
            "<none>",
            _bugreport_section(
                porcelain.bugreport(self.test_dir, env={}), "Enabled Hooks"
            ),
        )
    ...
    def test_a_path_that_is_not_a_repository(self) -> None:
        ...
        self.assertEqual(
            ...
            _bugreport_section(
                porcelain.bugreport(not_a_repo, env={}), "Enabled Hooks"
            ),
        )
