...
class ShaFile:
    ...
    @classmethod
    def from_file(cls, f: Union[BufferedIOBase, IO[bytes], "_GitFile"], sha: ObjectID | None = None) -> "ShaFile":
...
def parse_tree(text: bytes, strict: bool = False, hash_algorithm=None) -> Iterator[tuple[bytes, int, bytes]]:
    """Parse a tree text.
