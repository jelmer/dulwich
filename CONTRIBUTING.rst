...
as code changes will be visible immediately, without requiring a reinstall (but any
running Python processes will need to be reloaded to see the updated module definitions).
